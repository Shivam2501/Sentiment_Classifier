...
// 
...
public class SentimentClassifier extends SparseNetworkLearner
{
  ...
  static
  {
    _lcFilePath = SentimentClassifier.class.getResource("SentimentClassifier.lc");

    if (_lcFilePath == null)
    {
      System.err.println("ERROR: Can't locate SentimentClassifier.lc in the class path.");
      System.exit(1);
    }

    _lexFilePath = SentimentClassifier.class.getResource("SentimentClassifier.lex");

    if (_lexFilePath == null)
    {
      System.err.println("ERROR: Can't locate SentimentClassifier.lex in the class path.");
      System.exit(1);
    }
  }
  ...
  private static void loadInstance()
  {
    if (instance == null)
    {
      instance = (SentimentClassifier) Learner.readLearner(_lcFilePath);
  ...
  public static SentimentClassifier instance;
  ...
  private SentimentClassifier(boolean b)
  {
    super(new Parameters());
    containingPackage = "edu.illinois.cs.cogcomp.sentiment.sentiment";
    name = "SentimentClassifier";
    setEncoding(null);
    setLabeler(new SentimentLabel());
    setExtractor(new SentimentClassifier$$1());
    isClone = false;
  }
  ...
  {
    super("edu.illinois.cs.cogcomp.sentiment.sentiment.SentimentClassifier");
    isClone = true;
  }

	public SentimentClassifier(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

	public SentimentClassifier(Parameters p, String modelPath, String lexiconPath) {
		super(p);
		try {
		...
		else if (IOUtilities.existsInClasspath(SentimentClassifier.class, modelPath)) {
			readModel(IOUtilities.loadFromClasspath(SentimentClassifier.class, modelPath));
			readLexiconOnDemand(IOUtilities.loadFromClasspath(SentimentClassifier.class, lexiconPath));
		}
		else {
			containingPackage = "edu.illinois.cs.cogcomp.sentiment.sentiment";
			name = "SentimentClassifier";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof Document || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'SentimentClassifier(Document)' defined on line 37 of SentimentClassifier.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: edu.illinois.cs.cogcomp.sentiment.sentiment.SentimentClassifier \\");
  ...
  public edu.illinois.cs.cogcomp.lbjava.util.OVector getNetwork()
  {
    if (isClone)
    {
      loadInstance();
