...
public class SentimentClassifier extends SparseNetworkLearner
{
  ...
  {
    if (instance == null) instance = new SentimentClassifier(true);
  }

  public static Parser getParser() { return new Reader("data/train.tsv"); }
  public static Parser getTestParser() { return new Reader("data/test.tsv"); }
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof Document || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'SentimentClassifier(Document)' defined on line 25 of SentimentClassifier.lbj received '" + type + "' as input.");
